...
class Initdata {
  ...
  static Future<void> addBudgetDetail() async {
    ...
    Category cat1z = Category(id: 1,name: "Ăn uống", type: 0);
    Category cat2z = Category(id: 2,name: "Du lịch", type: 0);
    Category cat3z = Category(id: 3,name: "Mua sắm", type: 0);
  ...
  static Future<void> addTransaction() async {
    ...
    TransactionModel tra1 = TransactionModel(date: "2024-09-05", amount: 30000, wallet: wal1, category: cat1, note: "Ăn trưa", description: "", repeat_option: rep0);
    TransactionModel tra2 = TransactionModel(date: "2024-09-05", amount: 40000, wallet: wal1, category: cat1, note: "Ăn tối", description: "", repeat_option: rep0);
    TransactionModel tra3 = TransactionModel(date: "2024-09-04", amount: 582000, wallet: wal2, category: cat3, note: "Mua đồ dùng trong trọ", description: "- Chổi 50k \n- Gối 99k\n- Nệm 400k", repeat_option: rep0);
    TransactionModel tra4 = TransactionModel(date: "2024-09-04", amount: 1200000, wallet: wal2, category: cat3, note: "Đóng tiền nhà", description: "", repeat_option: rep3);
    TransactionModel tra5 = TransactionModel(date: "2024-09-02", amount: 3000000, wallet: wal2, category: cat2, note: "Đi du lịch cùng gia đình", description: "", repeat_option: rep0);
    TransactionModel tra6 = TransactionModel(date: "2024-09-02", amount: 500000, wallet: wal2, category: cat5, note: "Thưởng ngày lễ", description: "", repeat_option: rep0);
    ...
    TransactionModel tra8 = TransactionModel(date: "2024-08-04", amount: 200000, wallet: wal1, category: cat6, note: "Nhặt được của bác hàng xóm", description: "", repeat_option: rep0);
